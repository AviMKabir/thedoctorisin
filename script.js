    ...
    $.ajax({
        ...
        if (count === 0) {
            ...
            for (let i = 0; i < response.data.length; i++) {
                ...
                var tr = $("<div class = ' thedocs row thedocdiv card ' >");

                // this is lowkey genius right here isn't it?

                var doctor_img = $(" <div class = 'container row thedocs'> <img class = ' thedocs col-lg-2' src=" + doc_photo_link + "> <div class = ' col thedocs thedocsfullbio' >" + doctor_profile + "</div> </div>");

                var docTd = $("<div class = ' container thedocs thedocsheader text-white card-header text-center ' >").text(doctor_name);
